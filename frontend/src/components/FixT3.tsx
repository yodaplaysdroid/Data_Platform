    ...
    <>
                ...
                {visibleRows.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.货主名称}</TableCell>
                      <TableCell align="right">{row.货主代码}</TableCell>
                      <TableCell align="right">{row.物流公司_货代}</TableCell>
                      <TableCell align="right">{row.集装箱箱号}</TableCell>
                      <TableCell align="right">{row.货物名称}</TableCell>
                      <TableCell align="right">{row.货重_吨}</TableCell>
                    </TableRow>
                  );
                })}
                {emptyRows > 0 && (
      ...
      <div>
        <Modal open={openModal} onClose={handleCloseModal}>
          ...
          >
            <Edit tableName="物流信息" itemId={Number(selected)} />
          </Box>
        </Modal>
      </div>
    </>
