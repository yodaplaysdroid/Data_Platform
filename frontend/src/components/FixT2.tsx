    ...
    <>
                ...
                {visibleRows.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.客户名称}</TableCell>
                      <TableCell align="right">{row.客户编号}</TableCell>
                      <TableCell align="right">{row.手机号}</TableCell>
      ...
      <div>
        <Modal open={openModal} onClose={handleCloseModal}>
          ...
          >
            <Edit tableName="客户信息" itemId={Number(selected)} />
          </Box>
        </Modal>
      </div>
    </>
